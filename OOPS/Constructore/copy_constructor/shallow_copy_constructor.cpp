...
//The main problem in shallow copy is when we have make the copy of the one object into other, 
...
class student 
{
    public:
        ...
        // call the normal object creates for the first time, here we have passed paramteres means "*parameterised constructor*"
